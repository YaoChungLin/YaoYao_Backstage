...
import com.yaoyao.common.PicUploadResult;
...
public class PicUploadController {
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile , HttpServletResponse response) throws Exception {
		...
		// 生成图片的绝对引用地址
		String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, "D:\\yaoyao\\yaoyao-upload"), "\\", "/");
		fileUploadResult.setUrl("http://image.yaoyao.com" + picUrl);
	...
	private String getFilePath(String sourceFileName) {
		String baseFolder = "D:\\yaoyao\\yaoyao-upload" + File.separator + "images";
