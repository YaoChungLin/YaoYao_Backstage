package com.yaoyao.manage.service.api;
...
public class ApiItemCatService extends BaseService<ItemCat>{
    ...
    private static final String REDIS_KEY="YAOYAO_MANAGE_TIME_CAT_API";
